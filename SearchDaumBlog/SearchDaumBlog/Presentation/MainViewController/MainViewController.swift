    ...
    private func bind() {
        ...
        Observable
            ...
            .flatMapLatest { alert -> Signal<AlertAction> in
                let alertContoller = UIAlertController(title: alert.title, message: alert.message, preferredStyle: alert.style)
                return self.presentAlertController(alertContoller, actions: alert.actions)
            }
