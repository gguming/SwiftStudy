//
//  BookmarkColletionViewCell.swift
//  translate
//
...
final class BookmarkColletionViewCell: UICollectionViewCell {
    static let identifier = "BookmarkColletionViewCell"
    ...
    func setup(from bookmark: Bookmark) {
        ...
        sourceBookmarkTextStackView = BookmarkTextStackView(language: bookmark.sourceLanguage,
                                                            ...
                                                            type: .source)
        targetBookmarkTextStackView = BookmarkTextStackView(language: bookmark.translateLanguage,
