...
final class BookmarkListViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        collectionView.register(BookmarkColletionViewCell.self,
                                forCellWithReuseIdentifier: BookmarkColletionViewCell.identifier)
...
extension BookmarkListViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: BookmarkColletionViewCell.identifier, for: indexPath) as? BookmarkColletionViewCell
